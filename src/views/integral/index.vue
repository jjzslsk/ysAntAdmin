<template>
  <section class="app-container">
    ...
    <el-table :data="list" highlight-current-row @selection-change="selsChange()" style="width: 100%;">
      ...
      <el-table-column prop="key1" label="Presentid" width="150">
      </el-table-column>
      <el-table-column prop="key2" label="会员" width="150">
      </el-table-column>
      <el-table-column prop="key3" label="业务" width="150">
      </el-table-column>
      <el-table-column prop="key4" label="资金类型" width="150">
      </el-table-column>
      <el-table-column prop="key5" label="积分类型" width="150">
      </el-table-column>
      <el-table-column prop="key6" label="积分" width="150">
      </el-table-column>
      <el-table-column prop="key7" label="释放期数" width="150">
      </el-table-column>
      <el-table-column prop="key8" label="提交时间" width="150">
      </el-table-column>
      <el-table-column prop="key9" label="说明" width="150">
      </el-table-column>
      <el-table-column prop="key10" label="积分余额" width="150">
      </el-table-column>
