  ...
  <section class="app-container">
    ...
    <a-row :gutter="24">
        ...
        <a-col  :span="8">
            ...
            <a-select>
              <a-select-option value='male'>登录</a-select-option>
              <a-select-option value='female'>退出</a-select-option>
              <a-select-option value='female'>添加</a-select-option>
              <a-select-option value='female'>删除</a-select-option>
              <a-select-option value='female'>编辑</a-select-option>
              <a-select-option value='female'>其他</a-select-option>
            </a-select>
            </a-form-item>
        </a-col>
