  ...
  <section class="app-container">
    <el-card class="box-card">
      ...
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <a-button
          type="primary"
          v-if="isShowButton.add"
          @click="handleAdd"
          :icon="buttonList[0].Icon"
        >{{buttonList[0].Name}}</a-button>
        <a-button
          type="primary"
  ...
  <el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">
    <el-checkbox :label="city.Name" >{{city.Name}}</el-checkbox>
        ...
        <a-row style="margin: 5px 0;" v-for="index in menuListInfo" :key="index.key">
          <a-col :span="4">
            <a-checkbox @change="checkboxChange" :value="index.key">{{index.Name}}</a-checkbox>
          </a-col>
          <!-- <a-select
      size="large"
       mode="multiple"
    ...
    >
      <a-select-option v-for="item in index.Buttons" :key="item.Id.toString()">
        {{item.Name.toString()}}
          ...
          已有权限
          <!-- {{index.ButtonData}} -->
          :{{index.ButtonDataName}}:ButtonData:{{index.ButtonData}}
          ...
          <a-checkbox-group
            :options="defaultValueInfo(index.Buttons,index.ButtonData,index.MenuId,index.key)"
...
const treeDatas = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        Code: "rolemanagement",
        Url: "/views/rolemanagement/index",
        Sort: "1",
        Show: "√",
      ...
      },
      {
        ...
        Code: "usermanagement",
        Url: "/views/usermanagement/index",
        Sort: "1",
        Show: "√",
        children: null,
        Edit: "编辑",
      ...
      },
      {
        ...
        Code: "divisionmanage",
        Url: "/views/divisionmanage/index",
        Sort: "1",
        Show: "√",
        children: null,
        Edit: "编辑",
      ...
      },
      {
        ...
        Code: "datadictionary",
        Url: "/views/datadictionary/index",
        Sort: "1",
        Show: "√",
        children: null,
        Edit: "编辑",
      ...
      {
        key: "1064",
        Icon: "anticon anticon-file-unknown",
        Code: "test",
        Url: "/views/test/index",
        Sort: "1",
        Show: "√",
        children: null,
        Edit: "编辑",
      ...
      },
      {
        ...
        Code: "navigationmenu",
        Url: "/views/navigationmenu/index",
        Sort: "2",
        Show: "√",
        children: null,
        Edit: "编辑",
  ...
  methods: {
    ...
    checkboxChange(e) {
      ...
      if (e.target.checked) {
        ...
        this.roleInfoData.MenuId = this.menuId;

        if (this.roleObj.Power.length == 0) {
          this.roleObj.Power.push(this.roleInfoData);
        }

        if (this.roleObj.Power.length > 0) {
          this.roleObjIs = true;
          this.roleObj.Power.find(item => {
            if (item.MenuId == this.menuId) {
              this.roleObjIs = false;
              console.log("重复了");
            }
            // this.roleObjIs = true
          });
      ...
      if (e.target.checked == false) {
        this.roleObj.Power.splice(
          this.roleObj.Power.findIndex(index => index.MenuId == e.target.value),
          1
        );
        // this.roleObj.Power.forEach((index)=>{
        //   // console.log (index)

        //   if(index.MenuId == e.target.value){
        //     index.splice()
        //   // console.log (index)
    ...
    checkboxOnChange(checkedValues) {
      ...
      if (checkedValues.length > 0) {
        ...
        this.roleInfoData.Buttons = this.roleButtons;
    ...
    roleSelectData() {
      this.$confirm("确认为该菜单分配按钮吗?", "提示", {
        ...
        this.para.Data = JSON.stringify(this.roleObj);
