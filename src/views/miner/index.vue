<template>
  <section class="app-container">
    ...
    <el-table :data="list" highlight-current-row @selection-change="selsChange()" style="width: 100%;">
      ...
      <el-table-column prop="key3" label="矿机编号" width="150">
      </el-table-column>
      <el-table-column prop="key4" label="矿机级别" width="150">
      </el-table-column>
      <el-table-column prop="key5" label="矿机成本" width="150">
      </el-table-column>
      <el-table-column prop="key6" label="已生产币" width="150">
      </el-table-column>
      <el-table-column prop="key7" label="日生产币数量" width="150">
      </el-table-column>
      <el-table-column prop="key8" label="生产期数" width="150">
      </el-table-column>
      <el-table-column prop="key9" label="购买时间" width="150">
      </el-table-column>
      <el-table-column prop="key14" label="宝石" width="150">
      </el-table-column>
      <el-table-column prop="key15" label="UTMT" width="150">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getKeyList() {
        ...
        this.listPara.Code = 'GetListIssuehis'
