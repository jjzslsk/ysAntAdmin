  ...
  <section class="app-container">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        <el-form-item>
          <el-input  v-model="filters.mingcheng" placeholder="名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="list" highlight-current-row @selection-change="selsChange()" style="width: 100%;">
      ...
      <el-table-column prop="key4" label="充值金额" width="150">
      </el-table-column>
      <el-table-column prop="key5" label="汇款信息" width="150">
      </el-table-column>
      <el-table-column prop="key6" label="钱包地址" width="150">
      </el-table-column>
      <el-table-column prop="key7" label="冲币地址" width="150">
      </el-table-column>
      <el-table-column prop="key8" label="提交时间" width="150">
      </el-table-column>

      <el-table-column prop="shifouqiyong" label="是否确认" width="150" :formatter="function(row,colum){return row.shifouqiyong==true?'是':'否'}">
      </el-table-column>
    ...
    data() {
      ...
      return {
        bllCode: { //接口标识，由后端提供 
          ...
          del: 'DelSource', //删除
          getList: 'GetListCentervoucher', //获取列表
