<template>
  <section class="app-container">
    ...
    <el-table :data="list" highlight-current-row @selection-change="selsChange()" style="width: 100%;">
      ...
      <el-table-column prop="key1" label="ID" width="60">
      </el-table-column>
      <el-table-column prop="key2" label="账号" width="150">
      </el-table-column>
      <el-table-column prop="key3" label="矿机编号" width="150">
      </el-table-column>
      <el-table-column prop="key5" label="升级金额" width="150">
      </el-table-column>
      <el-table-column prop="key6" label="提交时间" width="180">
      </el-table-column>
      <el-table-column prop="key7" label="说明" width="150">
      </el-table-column>
      <el-table-column prop="key8" label="原级别" width="150">
      </el-table-column>
      <el-table-column prop="key9" label="升级级别" width="150">
      </el-table-column>
      <el-table-column prop="key10" label="是否确认" width="150">
      </el-table-column>
      <el-table-column prop="key11" label="宝石" width="150">
      </el-table-column>
      <el-table-column prop="key12" label="UTMT" width="150">
      </el-table-column>
