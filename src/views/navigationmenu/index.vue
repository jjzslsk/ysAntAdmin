<template>
  <section class="app-container">
    ...
    <a-icon slot="filterIcon" class="aIcon" slot-scope="filtered" type='tag' :style="{ color: filtered ? '#108ee9' : '#aaa' }" />
    ...
    //提交按钮
      ...
      handlePost(this.para).then(res => {
        if (res.IsSuccess == true) {
          ...
          if(res.Data[0].ButtonIds.length = '[]'){
            alert (2)
          // this.checkedList = []
          };
          if(typeof res.Data[0].ButtonIds == 'null'){
            alert (2)
          // this.checkedList = []
          };
          if(res.Data[0].ButtonIds !== null){
            alert (2)
          // this.checkedList = []
          };
          if (res.Data[0].ButtonIds.length = 0){
